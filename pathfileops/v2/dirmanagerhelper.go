...
func (dMgrHlpr *dirMgrHelper) setDirMgrFromKnownPathDirName(
  ...
  if lDirName > 0 {
    workingDirName, lDirName =
      fh.StripLeadingDotSeparatorChars(workingDirName)
  }
  ...
  if lDirName == 0 {
    ...
    finalPathStr = pathStr

  } else if pathStr[strLen-1] != os.PathSeparator {

    finalPathStr = pathStr + string(os.PathSeparator) + workingDirName

  } else {

    finalPathStr = pathStr + workingDirName
  }
