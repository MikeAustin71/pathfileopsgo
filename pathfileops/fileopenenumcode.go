...
//
//
//  FileOpenStatus - If successful, this method will return a new, fully initialized instance
//                   of FileOpenStatus.
//
...
//
func (fOpenStat FileOpenStatus) New(fOpenType FileOpenType, fOpenModes ...FileOpenMode) (FileOpenStatus, error) {

	ePrefix := "FileOpenStatus.New() "
	...
	resultFOpenStatus := FileOpenStatus{}
...
//
func (fOpenStat *FileOpenStatus) GetCompositeFileOpenCode() (int, error) {

	ePrefix := "FileOpenStatus.GetCompositeFileOpenCode() "

	if !fOpenStat.isInitialized {
		return -1,
			errors.New(ePrefix + "Error: The current FileOpenStatus instance is INVALID!")
	}
...
func (fOpenStat *FileOpenStatus) GetFileOpenModes() []FileOpenMode {
...
func (fOpenStat *FileOpenStatus) GetFileOpenType() FileOpenType {
...
// instance.
func (fOpenStat *FileOpenStatus) SetFileOpenType(fOpenType FileOpenType) error {

	ePrefix := "FileOpenStatus.SetFileOpenType() "
...
// replaces the internal stored FileOpenMode values for this FileOpenStatus instance.
//
...
//
func (fOpenStat *FileOpenStatus) SetFileOpenModes(fOpenModes ...FileOpenMode) {
